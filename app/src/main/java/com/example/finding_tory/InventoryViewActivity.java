...
public class InventoryViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inventory.addItem(new Item(new Date(123, 1, 24), "Item1", "make1", "model1", 10.01f, "1", "no comment", tags1));
        inventory.addItem(new Item(new Date(123, 1, 25), "Item2", "make2", "model2", 20.02f, "2", "No comment", tags2));
        inventory.addItem(new Item(new Date(123, 2, 27), "Item3", "make1", "model3", 30.03f, "3", "no Comment", tags2));
        inventory.addItem(new Item(new Date(123, 9, 13), "Item4", "make4", "model1", 400.40f, "4", "no commenT", tags1));
